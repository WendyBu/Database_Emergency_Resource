...
-- INCIDENTS
INSERT INTO Incident(date, description, latitude, longitude, owner) VALUES ('20160618', 'Flash Floods in Fulton County', 33.662379, -84.516327,'jsmith');
INSERT INTO Incident(date, description, latitude, longitude, owner) VALUES ('20160619', 'North GA Landslide', 34.297404, -83.819744,'usarmy');
INSERT INTO Incident(date, description, latitude, longitude, owner) VALUES ('20160621', 'Midtown Building Collapse', 33.789197, -84.384288,'delta');
INSERT INTO Incident(date, description, latitude, longitude, owner) VALUES ('20160621', 'Cat Stuck in Tree', 33.785404, -84.374516,'cityofatlanta');
INSERT INTO Incident(date, description, latitude, longitude, owner) VALUES ('20160621', 'Creepy Clowns on the Loose', 33.730994, -84.379675,'cityofatlanta');
...
INSERT INTO Resource(name, model, latitude, longitude, primary_esf, cost_amount, cost_unit, owner)
  VALUES ('Gasoline Generator', 'Honda EU2000i 1600 Watt', 33.564689, -84.576253, 12, 50, 'day', 'jsmith');
...
INSERT INTO Request(resource_id, requester_id, start_date, end_date, incident_id, type, owner)
  VALUES(3,'jsmith','20161118', '20161201', 1, 1, 'usarmy');
INSERT INTO Request(resource_id, requester_id, start_date, end_date, incident_id, type, owner)
  VALUES(1,'delta','20161120', '20161222', 3, 1, 'jsmith');
INSERT INTO Request(resource_id, requester_id, start_date, end_date, incident_id, type, owner)
  VALUES(4,'jsmith','20161119', '20161224', 1, 2, 'cityofatlanta');
INSERT INTO Request(resource_id, requester_id, start_date, end_date, incident_id, type, owner)
  VALUES(5,'jsmith','20161120', '20161221', 1, 1, 'delta');
INSERT INTO Request(resource_id, requester_id, start_date, end_date, type, owner)
  VALUES(2,'jsmith','20161123', '20161204', 0, 'jsmith');
INSERT INTO Request(resource_id, requester_id, start_date, end_date, incident_id, type, owner)
  VALUES(2,'cityofatlanta','20161206', '20161216', 4, 1, 'jsmith');
INSERT INTO Request(resource_id, requester_id, start_date, end_date, incident_id, type, owner)
  VALUES(3,'cityofatlanta','20161205', '20161216', 5, 1, 'usarmy');
